...
```bash
export PYTHONPATH=./
python inference/genefacepp_infer.py --debug --a2m_ckpt=checkpoints/audio2motion_vae --head_ckpt= --torso_ckpt=checkpoints/motion2video_nerf/XueLi_torso --drv_aud=data/raw/val_wavs/input_audio_zh_short.wav  --out_name=xueli_demo_1.mp4
```
