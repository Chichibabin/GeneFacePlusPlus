...
echo "Head NeRF training time: $((end_time_head - start_time_head)) seconds" | tee head_training_time.txt
...
echo "Torso NeRF training time: $((end_time_torso - start_time_torso)) seconds" | tee torso_training_time.txt
